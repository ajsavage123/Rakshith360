          ...
          <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              {uniqueSpecialties.length === 1 
                ? getSpecialtyConfig(uniqueSpecialties[0]).description
                : `These specialties are recommended based on your symptoms. ${uniqueSpecialties.map(s => getSpecialtyConfig(s).description.split('.')[0]).join('. ')}.`
              }
            </p>
          </div>
        </CardContent>
